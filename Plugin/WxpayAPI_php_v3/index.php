<!--?php header("Location:/PAY/example/jsapi.php") ?-->
<html>
<head>
...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="http://wechattest.qysvip.com/protected/classes/wechatpayments//jsapi.php">JSAPI支付</a></li>
